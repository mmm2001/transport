...
N = \frac{\rho ~ N_A}{A}
\end{equation*}
$N_A$ -- число Авогадро, $6.022 \cdot 10^{23}$ 1/моль.
измеряется в см$^{-3}$.
\begin{equation*}
N_{\Delta x} = \frac{\rho ~ N_A}{A} \Delta x
\end{equation*}

\begin{equation*}
p(\Delta x) = 1 - \frac{\nu(x+\Delta x)}{\nu(x)} = \underbrace{\sigma N_{\Delta x}}_{\sigma \frac{\rho ~ N_A}{A} \Delta x }
\end{equation*}

\begin{equation*}
\frac{\nu(x) - \nu(x+\Delta x)}{\nu(x)} = \sigma \Delta x \frac{\rho N_A}{A}
\end{equation*}
\begin{equation*}
