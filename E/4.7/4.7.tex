...
Аналогия здесь по всей видимости в том, что полученное уравнение на $\psi_g$ имеет такой же вид, как рассматриваемое нами ранее уравнение для переноса нейтронов $\rightarrow$ к нему применимы все те же методы решения.
